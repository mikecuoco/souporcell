...
knitr::opts_chunk$set(cache = FALSE, fig.path = NULL)
...
glue("Souporcell processed {nbarcodes} total barcodes inti {nclust} clusters") %>% print()
...
```{r pca, echo=TRUE, fig.width=20, fig.height=20}
